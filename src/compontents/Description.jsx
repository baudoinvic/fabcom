  ...
  return (
    <div className="bg-gray-100 ">
      <div className="text-center p-8 transition">
        ...
        <p className="text-left text-gray-600 ml-80">
          FabLab Rwanda is a space for members to turn innovative ideas into
          products specifically in the hardware and electronics domain.<br></br>{" "}
          The space provides a platform for capacity building and integration of
          hardware skills with software knowledge and quickly bringing Rwandan
          innovators closer<br></br> to the Internet of Things era. The space
          provides collaborative community, Knowledge base and innovation
          business model Guidance with a core focus<br></br> to increase
          Rwanda’s competitiveness in the fields of Design, Engineering,
          Electronics, Fabrication and High-Tech innovative business.<br></br>{" "}
          FABLAB Rwanda also serves as a model for the nation’s leaders in
          policy, government, and industry<br></br> to experience, first hand,
          Fab Lab’s grass roots approach in developing technical education and
          literacy, promoting innovation and launching<br></br> inventions while
          transforming traditional industries into digital fabrication agents.
        </p>
      </div>
